...
class BasicTax : public TaxItemBase
{
public:
    BasicTax(std::string tax_item_name, unsigned int tax_rate_percent, std::unordered_set<std::string> exemptions_list) : tax_item_name_(tax_item_name),
